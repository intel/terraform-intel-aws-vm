...
This example creates an AWS EC2 instance on 6th Generation Intel® Xeon® Scalable Processor (Granite Rapids) on Linux Operating System in a non-default VPC. The non-default VPC id is needed to be passed in this module as a variable. It is configured to create the EC2 instance in US-East-1 region. The region is provided in variables.tf in this example folder.
